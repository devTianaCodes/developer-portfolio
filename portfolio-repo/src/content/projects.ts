...
import { resolveLiveAppUrl } from "@/lib/liveAppUrl";
...
const fullStackLiveUrls = {
  chocolate: resolveLiveAppUrl(process.env.NEXT_PUBLIC_CHOCOLATE_WEB_APP_URL, "https://chocolate-frontend-one.vercel.app"),
  petnest: resolveLiveAppUrl(process.env.NEXT_PUBLIC_PETNEST_WEB_APP_URL, "https://petnest-frontend.vercel.app")
} as const;
