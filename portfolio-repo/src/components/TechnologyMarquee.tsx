      ...
      {siteConfig.stackBands.map((tech) => (
        <li key={tech}>
          <ProjectTechBadge
            tech={tech}
            compact
            className="whitespace-nowrap border-white/25 bg-white/95 px-3 py-2 text-micro text-black shadow-none sm:px-4 sm:text-xs sm:shadow-[0_8px_20px_rgba(0,8,28,0.16)]"
          />
        </li>
      ))}
    </ul>
